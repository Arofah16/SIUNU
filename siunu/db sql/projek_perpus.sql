...
INSERT INTO `tbl_buku` (`id_barang`, `buku_id`, `id_kategori`, `id_ruang`, `sampul`, `isbn`, `lampiran`, `title`, `penerbit`, `pengarang`, `thn_buku`, `isi`, `jml`, `tgl_masuk`) VALUES
...
INSERT INTO `tbl_rak` (`id_ruang`, `nama_rak`) VALUES
(1, 'Rak Buku 1');
