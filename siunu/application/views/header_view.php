...
<head>
    ...
    <title><?php echo $title_web;?> | Sistem Informasi Inventaris UNU Yogyakarta </title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
                ...
                <span class="logo-lg">Sistem Informasi Inventaris UNU Yogyakarta </span>
            </a>
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <!--mulai menampilkan nama admin di header -->
                        <li>
                            <?php
                        ...
                        <!-- akhir menampilakn admin di header -->
