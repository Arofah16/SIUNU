...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
    ...
    <div class="login-box">
        ...
        <div class="login-logo">
            <a href="index.php" style="color: white;">Sistem Informasi <br /><b>Inventaris UNU Yogyakarta</b></a>
        </div>
        ...
        <footer>
            <div class="login-box-body text-center bg-blue">
                <a style="color: yellow;"> Copyright &copy; Sistem Informasi Inventaris - <?php echo date("Y");?>
            </div>
        </footer>
    </div>
    <!-- /.login-box -->
