                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly value="<?= $user->user;?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="level" class="form-control" required="required">
                                            ...
                                            <option <?php if($user->level == 'Pimpinan'){ echo 'selected';}?>>Pimpinan
                                            </option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br />
                                        <img src="<?= base_url('assets_style/image/'.$user->foto);?>"
