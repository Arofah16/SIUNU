...
class Gedung extends CI_Controller {
    ...
    {	
        ...
        // $this->data['gedung'] = $this->M_Gedung->get_table('tbl_gedung');
        $this->data['gedung'] =  $this->db->query("SELECT * FROM tbl_gedung ORDER BY id_gedung DESC");
        $this->data['title_web'] = 'Data Gedung ';
        $this->load->view('header_view',$this->data);
        $this->load->view('sidebar_view',$this->data);
        $this->load->view('gedung/gedung_view',$this->data); 
